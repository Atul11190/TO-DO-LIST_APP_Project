...
def init_gui():
    ...
    add_button = tk.Button(window, text="Add Task", width=20, font=("Arial", 12), bg="#90EE90", command=add_task)
    add_button.pack(pady=10)
    
    delete_button = tk.Button(window, text="Delete Task", width=20, font=("Arial", 12), bg="#FFCCCB", command=delete_task)
    ...
    signature_label = tk.Label(window, text="App by Atul Kumar", font=("Arial", 10, "italic"), bg="#F0F8FF", fg="#555")
